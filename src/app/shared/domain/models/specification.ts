...
export interface Specification<T = PostgrestFilterBuilder<ClientServerOptions, GenericSchema, GenericTable | GenericView, unknown>> {
  apply(query: T): T;
}
...
export class IlikeSpecification implements Specification {
  ...
  apply(query: PostgrestFilterBuilder<ClientServerOptions, GenericSchema, GenericTable | GenericView, unknown>): PostgrestFilterBuilder<ClientServerOptions, GenericSchema, GenericTable | GenericView, unknown> {
